...
const PRESERVED_FIELD_PLACEHOLDER = "••••••••";
...
export default function WebhooksTab() {
  ...
  function startEdit(endpoint: WebhookEndpoint) {
    setForm({
      ...
      url: PRESERVED_FIELD_PLACEHOLDER,
      botToken: PRESERVED_FIELD_PLACEHOLDER,
      chatId: PRESERVED_FIELD_PLACEHOLDER,
      secret: PRESERVED_FIELD_PLACEHOLDER,
      serverUrl: PRESERVED_FIELD_PLACEHOLDER,
      topic: PRESERVED_FIELD_PLACEHOLDER,
      token: PRESERVED_FIELD_PLACEHOLDER,
    });
    setEditing(true);
    setError(null);
  }
  ...
  function buildConfig(): WebhookConfig {
    const clean = (value: string) =>
      value === PRESERVED_FIELD_PLACEHOLDER ? undefined : value.trim();
    switch (form.provider) {
      case "telegram":
        return { botToken: clean(form.botToken), chatId: clean(form.chatId) };
      case "ntfy":
        return {
          url: clean(form.url),
          serverUrl: clean(form.serverUrl),
          topic: clean(form.topic),
